...
export interface CanonicalGroup {
  id: CanonicalGroupId;
  // Verbatim copy of the live schedule card's own group name, whatever it
  // actually says — used everywhere in the admin Groups tab (section
  // headers, per-athlete badges, the add/remove toggle buttons). Most cards
  ...
  // detail here that isn't literally on the card.
  label: string;
...
export const CANONICAL_GROUPS: CanonicalGroup[] = [
  { id: "junior", label: "Junior Boys & Girls — Grade 5 & Below", gender: "coed", minGrade: "K", maxGrade: "5" },
  { id: "ms", label: "Middle School Boys & Girls", gender: "coed", minGrade: "5", maxGrade: "8" },
  { id: "hs-girls", label: "High School Girls", gender: "girls", minGrade: "7", maxGrade: "12" },
  { id: "jv-boys", label: "JV Boys", gender: "boys", minGrade: "7", maxGrade: "10", autoSeed: false },
  { id: "varsity-boys", label: "Varsity Boys", gender: "boys", minGrade: "8", maxGrade: "12", autoSeed: false },
];
