        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-brown-400 text-base max-w-2xl mx-auto leading-relaxed">
              Every player who joins gets a fully structured, personalized training experience — one that evolves with them the longer they train.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-brown-700 bg-brown-900/40 px-7 py-8">
              ...
              <p className="text-brown-300 text-sm leading-relaxed">
                When you join, you&apos;re placed into a structured 8-week program built around your current level — Beginner, Intermediate, or Advanced. Each week, your workouts are automatically generated based on where you are in the program. No guesswork. No figuring out what to do next. You just show up and train.
              </p>
            </div>

            <div className="rounded-2xl border border-brown-700 bg-brown-900/40 px-7 py-8">
              <p className="font-[family-name:var(--font-fira-cond)] text-2xl font-black tracking-wide text-mesa-accent mb-3">
                FEEDBACK THAT ACTUALLY MEANS SOMETHING.
              </p>
              <p className="text-brown-300 text-sm leading-relaxed">
                After every drill, you rate it — <span className="text-white font-semibold">Need More Work</span>, <span className="text-white font-semibold">Got It</span>, or <span className="text-white font-semibold">Too Easy</span>. The platform remembers. Drills you struggle with come back around more. Drills you&apos;ve mastered move to the background. Your program reshapes itself every single session based on your real performance — not a generic template.
              </p>
            </div>

            <div className="rounded-2xl border border-brown-700 bg-brown-900/40 px-7 py-8">
              <p className="font-[family-name:var(--font-fira-cond)] text-2xl font-black tracking-wide text-mesa-accent mb-3">
                STRUCTURED BY ME. NOT GENERATED BY A MACHINE.
              </p>
              <p className="text-brown-300 text-sm leading-relaxed">
                Every drill, every progression, every coaching cue — I built it. I designed the entire curriculum from the ground up based on what I&apos;ve learned playing at the D1 and professional level, and what I see working with players every single day. The platform is smart, but the content comes from real experience on a real court.
              </p>
            </div>

            <div className="rounded-2xl border border-brown-700 bg-brown-900/40 px-7 py-8">
              <p className="font-[family-name:var(--font-fira-cond)] text-2xl font-black tracking-wide text-mesa-accent mb-3">
                A COMPLETE WORKOUT, EVERY TIME.
              </p>
              <p className="text-brown-300 text-sm leading-relaxed">
                Each session covers all four areas of the game — Ball Handling, Finishing, Mid Range, and Shooting — in one focused hour. The platform selects the right drills for each category based on your history and where you are in the program, so no two players get the exact same workout. It&apos;s built to keep you developing across the full game, not just one skill.
              </p>
            </div>
          ...
          <div className="mt-10 rounded-2xl border border-mesa-accent/30 bg-mesa-accent/5 px-8 py-7 text-center">
            <p className="font-[family-name:var(--font-fira-cond)] text-2xl font-black tracking-wide text-white mb-2">
              NO TWO PLAYERS TRAIN THE SAME WAY.
            </p>
            <p className="text-brown-400 text-sm max-w-xl mx-auto leading-relaxed">
              Two players at the same level, in the same week of the program, will likely receive different workouts — because their feedback history is different. The platform tracks everything and adjusts. The longer you train, the more dialed-in your program becomes.
            </p>
          </div>
        </div>
      </section>
